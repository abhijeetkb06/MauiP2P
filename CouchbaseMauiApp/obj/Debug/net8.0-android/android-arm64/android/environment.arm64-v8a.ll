...
@dso_cache = dso_local local_unnamed_addr global [40 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2748515158655521009, ; hash 0x2624aff97b7050f1, from name: libLiteCore.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 10061150248302631901, ; hash 0x8ba062d835e95bdd, from name: LiteCore.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libLiteCore.so
		ptr null; void* handle (0x0)
	}, ; 22
	...
	%struct.DSOCacheEntry {
		i64 12182629091201764182, ; hash 0xa911649cb36bcb56, from name: libLiteCore
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libLiteCore.so
		ptr null; void* handle (0x0)
	}, ; 27
	...
	%struct.DSOCacheEntry {
		i64 17857924505592430646, ; hash 0xf7d417b8f5948036, from name: LiteCore
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libLiteCore.so
		ptr null; void* handle (0x0)
	}, ; 35
...
@.env.7 = private unnamed_addr constant [37 x i8] c"9db30df2-c13c-415d-a562-5e1db4617f2f\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.couchbase.syncflow\00", align 1
